...
const INDICATIVE_PRICING = [
    ...
    // DC BATTERY SYSTEM — add second record (charger + accessories)
    { bop_category: 'DC_Battery_System', sub_category: '110V DC Battery Charger & Distribution Panel', part_description: 'Battery charger, float/boost modes, DC distribution board, circuit breakers, monitoring relay — complete 110V DC system accessories', price_low_usd: 42_500, price_mid_usd: 50_000, price_high_usd: 57_500, source_supplier: 'Saft / EnerSys / NorthStar Battery', source_type: 'web_research', confidence: 'indicative', lead_time_weeks_low: 8, lead_time_weeks_high: 16, price_basis: 'Charger + distribution panel complement to battery bank. IEEE 946 design. ±15% from mid.', notes: 'Budget the battery bank (in DC_Battery_System main record) separately. This covers BOS electrical only.' },

    // ENCLOSURES — add second record (generator enclosure, separate from GT)
    { bop_category: 'Enclosures', sub_category: 'Generator Acoustic Enclosure', part_description: 'Acoustic enclosure for generator — modular steel panels, ventilation silencers, access doors, acoustic rating 85dB(A) at 1m', price_low_usd: 212_500, price_mid_usd: 250_000, price_high_usd: 287_500, source_supplier: 'FAIST Anlagenbau / IAC Acoustics / G+H Group', source_type: 'web_research', confidence: 'indicative', lead_time_weeks_low: 14, lead_time_weeks_high: 26, price_basis: 'Generator enclosure separate from GT enclosure. Ventilated, IP54+ panel construction. ±15% from mid.', notes: 'Size and noise spec drive cost significantly. Add $50-100K for full thermal/ventilation engineering if not site-tested.' },

    // FIRE FIGHTING — add second record (CO2 / clean agent for lube oil room)
    { bop_category: 'Fire_Fighting', sub_category: 'CO2 / Clean Agent Fire Suppression — Lube Oil Room', part_description: 'Total flooding clean agent suppression system for lube oil / electrical rooms — agent storage, nozzles, control panel, manual release, VESDA detection', price_low_usd: 63_750, price_mid_usd: 75_000, price_high_usd: 86_250, source_supplier: 'Fike Corporation / Marioff / Kidde', source_type: 'web_research', confidence: 'indicative', lead_time_weeks_low: 8, lead_time_weeks_high: 18, price_basis: 'Per lube oil room + 1 electrical room. NFPA 12 / FM Global design. Clean agent (Novec or CO2). ±15% from mid.', notes: 'Separate from outdoor GT fire protection (water deluge/sprinkler). Indoor total flood protects high-value equipment.' },
];
